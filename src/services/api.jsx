...
const baseURL = 'https://q9bsnf7k-8080.use2.devtunnels.ms'
...
const api = {
  get: async (url, options = {}) => {
    ...
    const headers = {
      ...
      ...(url.includes('/reset-password') || url.includes('/forgot-password')
        ? {}
        : { Authorization: `Bearer ${token}` }), // No agregar Auth header para reset-password y forgot-password
      ...options.headers,
    }
