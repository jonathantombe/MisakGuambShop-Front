...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const endpoint = form.roles[0] === 'seller' ? '/api/auth/signup/seller' : '/api/auth/signup/user';
            ...
            setError(error.message || 'Hubo un error al procesar tu solicitud. Por favor, inténtalo de nuevo.');
        }
    };
