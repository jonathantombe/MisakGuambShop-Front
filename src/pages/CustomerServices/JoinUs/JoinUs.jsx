      ...
      <div className='join-us-v'>
        <div className='join-us-container'>
          <div className='join-us-text'>
            ...
            <p>
              Misak es una plataforma pensada para que todas las comunidades indígenas vendan sus productos de forma rápida, segura y justa, tanto para el vendedor como para el comprador. Unimos a todas las comunidades en un solo lugar, ofreciendo artesanías auténticas y textiles únicos que celebran sus tradiciones. ¡Todo lo que deseas está aquí en Misap, donde la cultura se encuentra con la oportunidad de crecimiento!
            </p>
          </div>
          <img src={isotipoblack} alt="Historia de Misak" />
        </div>

        <div className='join-us-container'>
          <img src={NuestraHistoria} alt="Historia de Misak" />
          <div className='join-us-text'>
        <h1>
        ...
        <p>
          Te invitamos a explorar nuestra tienda y sumergirte en la riqueza cultural de los pueblos indígenas a través de nuestras colecciones. Al elegir Misak, estás apoyando la preservación de tradiciones ancestrales y fomentando un comercio justo que beneficia directamente a los artesanos. Únete a nosotros para celebrar la diversidad, la creatividad y la autenticidad en cada producto.
        </p>
          </div>
          <img src={UneteNosotros} alt="Compromiso de Misak" />
        </div>
      </div>
    </div>
  );
