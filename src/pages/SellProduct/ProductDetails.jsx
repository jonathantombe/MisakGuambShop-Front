  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        formData.append(
          "price",
          parseFloat(productData.price.replace(/[^\d]/g, "")) || 0
        );
        ...
        setTimeout(() => {
          ...
          navigate("/my/publications", {
            state: { refresh: true, newProductId: response.id },
          });
        }, 2000);
      } catch (error) {
      ...
      <div className="product-details__container-div">
        ...
        >
          <div className="product-details__form-group">
            <label htmlFor="name" className="product-details__label">
              Nombre del Producto
            </label>
            <div
              className={`product-details__input-wrapper ${
                errors.name ? "error" : ""
              }`}
            >
              <input
            ...
            {errors.name && (
              <p className="product-details__error">{errors.name}</p>
            )}
          </div>
          <div className="product-details__form-group">
            <label htmlFor="price" className="product-details__label">
              Precio
            </label>
            <div
              className={`product-details__input-wrapper ${
            ...
            {errors.price && (
              <p className="product-details__error">{errors.price}</p>
            )}
          </div>
          <div className="product-details__form-group">
            <label htmlFor="stock" className="product-details__label">
            ...
            {errors.stock && (
              <p className="product-details__error">{errors.stock}</p>
            )}
          </div>
          <div className="product-details__form-group">
            <label htmlFor="category" className="product-details__label">
              Categoría
            </label>
            <select
              id="category"
            ...
            {errors.category && (
              <p className="product-details__error">{errors.category}</p>
            )}
          </div>
          <div className="product-details__form-group">
            <label htmlFor="description" className="product-details__label">
              Descripción
            </label>
            <textarea
              id="description"
            ...
            />
            {errors.description && (
              <p className="product-details__error">{errors.description}</p>
            )}
          </div>
          <div className="product-details__form-group">
            <label htmlFor="images" className="product-details__label">
            ...
            >
              {productData.images.length > 0 ? (
                ...
                >
                  ...
                  <span>
                    Sube tu imagen en JPG, JPEG, PNG o WEBP con una resolución
                    mínima de 500 píxeles en ambos lados y hasta 20MB de peso.
                  </span>
                </div>
              )}
              <input
            ...
            {errors.images && (
              <p className="product-details__error">{errors.images}</p>
            )}
          </div>
          {submissionMessage && (
          ...
          {errors.submit && (
            <p className="product-details__error">{errors.submit}</p>
          )}
