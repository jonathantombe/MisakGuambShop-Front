...
const ProductManagementTable = ({
  ...
  return (
    <section className="product-management-section">
      ...
      {newProductButton && (
        <div className="new-product-button-container">{newProductButton}</div>
      )}
          ...
          <tbody>
            {products.map((product) => (
              <tr key={product.id}>
                ...
                <td>
                  <div
                    className={`status-text ${product.status.toLowerCase()}`}
                  >
                ...
                <td>
                  <div className="action-buttons">
                    <button
                      onClick={() => onAvailabilityChange(product, 'ENABLED')}
                    ...
                    <button
                      onClick={() => onAvailabilityChange(product, 'DISABLED')}
