                        ...
                        <div className="trending-product-content-special">
                            <div className="trending-product-content">
                                ...
                                <div className="trending-product-infos">
                                    <h3 className="product-name">{products[0]?.name || 'Producto'}</h3>
                                    <div className="product-rating-container">
                                        {renderStars(products[0]?.rating)}
                                        <span className="trending-rating-count">({products[0]?.rating?.toFixed(1) || '0.0'})</span>
                                    </div>
                            ...
                            <div className="trending-product-content">
                                ...
                                <div className="trending-product-info">
                                    ...
                                    <div className="trending-price-info">
                                        ...
                                        <p className="trending-discount-info">$280.00{product.discount || 0}</p>
                                    </div>
